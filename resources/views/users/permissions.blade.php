                                                ...
                                                <td>
                                                    ...
                                                    <div class="module-info">
                                                        ...
                                                        <div class="module-icon">
                                                            ...
                                                            <i class="ti {{ $icons[$module] ?? 'ti-apps' }}"></i>
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#permission_list_new').DataTable({
                    ...
                    ajax: {
                        url: `/users/${userId}/permission-data`,
                        type: "GET",
                        dataSrc: ""
                    },
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                function syncAllowAll() {
                    ...
                    allowAll.prop('checked', total > 0 && total === checked);
                }

                function syncRowCheckbox(row) {

                    let rowCheckboxes = row.find(
                        'input[name="permissions[]"]'
                    );

                    let checkedCount = rowCheckboxes
                        .filter(':checked')
                        .length;
                ...
                $(document).on(
                    ...
                    function() {
                        ...
                        $.ajax({
                            ...
                            url: `/users/${userId}/toggle-permission`,
                ...
                allowAll.on('change', function() {
                    ...
                    let permissions = allPermissionCheckboxes();
