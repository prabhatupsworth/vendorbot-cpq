    ...
    <div class="header-left active">
        <a href="/" class="logo logo-normal">
            <div class="d-flex align-items-center gap-2">
                <img style="width: 30px;" src="{{ asset('template/assets/img/vb_logo.png') }}" alt="Logo">
                <span class="font-weight-semibold" style="font-size:22px;"> Vendorbot</span>
            </div>
                                ...
                                <a href="activities.html">
                                    <div class="media d-flex">
                                        <span class="avatar flex-shrink-0">
                                            <img src="{{ asset('template/assets/img/profiles/avatar-02.jpg') }}"
                                                alt="Profile">
                            ...
                            <li class="notification-message">
                                <a href="activities.html">
                                    <div class="media d-flex">
                                        <span class="avatar flex-shrink-0">
                                            <img alt=""
                                                src="{{ asset('template/assets/img/profiles/avatar-06.jpg') }}">
                                        </span>
                                        <div class="media-body flex-grow-1">
